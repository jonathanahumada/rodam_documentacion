...
Sin embargo, si existe un documento de diseño se puede entender que en
su momento se consideró indispensable, ya sea para la implementación
del desarrollador o para comunicarse con el cliente.

Si se necesita más información acerca de qué es el diseño y como se
aplica al marco ágil, consultar "Software Engineering: Modern
